                ...
                <div className="grid md:grid-cols-2 gap-8">
                    {services.map((service, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="bg-card p-8 rounded-sm border-2 border-border hover:border-primary transition-all hover:bg-card"
                        >
                            <div className="mb-6 bg-background border border-border w-fit p-4 rounded-sm shadow-inner">
                                {service.icon}
                            </div>
                            ...
                            <ul className="space-y-2">
                                {service.features.map((feature, i) => (
                                    <li key={i} className="flex items-center gap-2 text-sm text-foreground font-bold">
